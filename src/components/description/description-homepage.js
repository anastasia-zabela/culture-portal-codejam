...
const Description = () => {
  return (
    <article className="description container-fluid">
      ...
      <img className="description__theater-img" alt="theater" width="500px" src="https://images.unsplash.com/photo-1563903227677-988f00ecc0fd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" />
